...
- **File Path:** `C:\Users\windows-user\Downloads\tor-browser-windows-x86_64-portable-14.0.1.exe`
...
- **Process:** `tor.exe`
- **File Path:** `c:\users\windows-user\desktop\tor browser\browser\torbrowser\tor\tor.exe`
